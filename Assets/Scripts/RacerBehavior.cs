...
public class RacerBehavior : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {    
            ...
            if (hp == 0)
            {
                enemyHPStatus.GetComponent<Text>().text = enemyHPStatus.GetComponent<Text>().text.Replace("Racer: 010", "Racer: 000");
                return; 
            }
            ...
            int newHP;
            try {
                newHP = int.Parse(oldHPString.Substring(7, 3)) - BULLET_DAMAGE;
            } catch {
                return;
            }
